...
<body>
    <div id="receipt">
        ...
        <div id="mid">
            <div class="info">
                <p>
                    Alamat : Sepangjang Jalan Kenanagan <br>
        ...
        <div id="bot">
            ...
            <div id="legalcopy">
                <p class="legal"><strong>Terima Kasih atas pembelian Anda!</strong> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consequuntur ex cumque quisquam labore veniam. Aperiam, perspiciatis. Consectetur, aperiam fugit?</p>
            </div>
        </div>
    </div>
